...
def combinar_defunciones ():
    
    ruta_proyecto = Path(__file__).resolve().parents[2]        
    ruta = Path("Bases de datos")
    archivos = [
        "defunciones_registradas_2019.csv",
        "defunciones_registradas_2020.csv",
        "defunciones_registradas_2021.csv",
        "defunciones_registradas_2022.csv",
        "defunciones_registradas_2023.csv"
    ]
    
    ruta = ruta_proyecto/ruta
    
    RENOMBRAR_COLUMNAS = False
    
    NUEVOS_NOMBRES = {
        "fb62c3a5-ce42-40f0-a365-c36b29cf1e1a.csv": [
            # "COL1", "COL2", "COL3", "COL4"
        ],
        "f6fab6c3-6cba-4e9f-a406-4ce7b8432565.csv": [
            # "COL1", "COL2", "COL3", "COL4"
        ],
        "b9e99b40-7b48-46f8-ab49-ac1e5dd2da9b.csv": [
            # "COL1", "COL2", "COL3", "COL4"
        ],
        "1b86d685-e36e-4e3a-8b30-e726772e7839.csv": [
            # "COL1", "COL2", "COL3", "COL4"
        ],
        "ea499485-8425-45ac-b5bd-a13e954d0728.csv": [
            # "COL1", "COL2", "COL3", "COL4"
        ],
    }
    ...
    for archivo in archivos:
        ...
        if "ENT_OCURR" in df.columns:
            df["ENT_OCURR"] = pd.to_numeric(df["ENT_OCURR"], errors="coerce")
            df = df[df["ENT_OCURR"] == 9].copy()
        else:
            print(f"[AVISO] El archivo {archivo} no tiene la columna ENT_OCURR y no se filtró.")
    ...
    print("############ DEFUNCIONES FEDERALES: FUSIÓN Y FILTRADO A CDMX ############\n")
    ...
    salida_comunes = ruta / "defunciones_registradas_cdmx_2019_2023.csv"
    ...
    print(f"Porcentaje de registros tras filtrado a CDMX: {porcentaje_reduccion} %" )
