# Limpieza y estandarización de CONSULTAS_OTORGADAS_HGM
...
def limpieza_estandarizacion_consultas_hospital():
    ...
    for columna in columnas_categoricas:
        ...
        imputaciones_categoricas += df_limpio[columna].isna().sum()
    ...
    print("##################################################")
    print("LIMPIEZA CONSULTAS HGM")
    print("##################################################\n")
    
    print("Archivo de salida:", archivo_salida)
    print("Imputaciones categóricas:", imputaciones_categoricas)
    ...
    total_correcciones = imputaciones_categoricas + imputaciones_edad + correcciones_descripcion + columnas_eliminadas
